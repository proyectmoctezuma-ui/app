...
const allGames = [
  {
    ...
    description: '<b><strong>Nuestro propósito</strong></b> se construye pieza por pieza. Une cada parte y descubre la fuerza de lo que nos inspira a avanzar.',
    unlocked: true,
    image: '/game-covers/1.jpg',
  },
  {
    id: 2,
    title: 'El tren del las decisiones',
    description: 'Guía el tren por el camino correcto, demostrando que la <strong><b>Honestidad e Integridad</b></strong> son los rieles que nos conducen e impulsan a un futuro solido.',
    unlocked: true,
  ...
  },
  {
    ...
    description: 'Avanza con conciencia y descubre como cada paso que das puede generar un impacto positivo en <strong><b>el Cuidado de Nuestro Planeta</b></strong>.',
    unlocked: true,
    image: '/game-covers/3.jpg',
  },
  {
    id: 4,
    title: 'Memorama de la inclusión',
    description: 'Encuentra coincidencias, celebra la diversidad y aprende que con <strong><b>Respeto e Inclusión</b></strong>, construimos un ambiente de <strong><b>colaboración</b></strong> positivo.',
    unlocked: false,
  ...
  },
  {
    ...
    description: 'Cada condición insegura que detectes es una vida que proteges. Actúa con <strong><b>Valor por la Vida</b></strong>: pon a prueba tu atención y conviértete en guardián de la seguridad.',
    unlocked: false,
  ...
  },
  {
    ...
    description: 'Afina tu punteria y demuestra que con <strong><b>Enfoque y Determinación</b></strong>, alcanzas el objetivo con la fuerza de quien no deja nada al azar.',
    unlocked: false,
